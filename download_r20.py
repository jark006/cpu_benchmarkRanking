...
url = [
    r'https://www.cpu-monkey.com/en/cpu_benchmark-cinebench_r20_single_core-9',
    r'https://www.cpu-monkey.com/en/cpu_benchmark-cinebench_r20_multi_core-10',
    ]

htmlPath = [
    r'data/r20_single.html',
    r'data/r20_multi.html'
]

path = [
    r'data/r20_single_list.txt',
    r'data/r20_multi_list.txt',
]
