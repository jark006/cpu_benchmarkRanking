...
if coreType == 'single':
    ...
    logoPath = 'pic/logoR15s.png'
    listPath = 'data/r15_single_list.txt'
    percent = [x for x in range(40, 261, 10)]+[280]
    ...
    intel_Column_desktop = {
        'i3': 8, 'i5': 4, 'i7': 6, 'i9': 8, 'E5': 0, 'Xeon': 2, 'Platinum': 0,'Core2': 4, 'Pentium': 8, 'Celeron': 6,
        'i32': 9, 'i52': 5, 'i72': 7, 'i92': 9, 'E52': 1, 'Xeon2': 3, 'Platinum2': 1,'Core22': 5, 'Pentium2': 9, 'Celeron2': 7,
        }

    amd_Column = {
        'EPYC': 0, 'TR': 0, 'R9': 0, 'R7': 1, 'R5': 2, 'R3': 3, 'RE': 4,'Bulldozer': 0, 'APU': 1, 'Phenom': 3, 'Athlon': 5, 'Turion': 5,
        'EPYC2': 0, 'TR2': 0, 'R92': 0, 'R72': 1, 'R52': 2, 'R32': 3, 'RE2': 4,'Bulldozer2': 0, 'APU2': 2, 'Phenom2': 4, 'Athlon2': 5, 'Turion2': 5,
        }
    # 修正分数
    fix_score = {
        # 'i9-10900K': 1420,
    ...
    logoPath = 'pic/logoR15m.png'
    listPath = 'data/r15_multi_list.txt'
    percent = [
        20, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160, 180, 200, 
        250, 300, 350,400, 500, 600, 800, 1000, 1500, 2500
    ]
    ...
    intel_Column_desktop = {
        'i3': 8, 'i5': 4, 'i7': 6, 'i9': 8, 'E5': 0, 'Xeon': 2, 'Platinum': 0,'Core2': 4, 'Pentium': 6, 'Celeron': 4,
        'i32': 9, 'i52': 5, 'i72': 7, 'i92': 9, 'E52': 1, 'Xeon2': 3, 'Platinum2': 1,'Core22': 5, 'Pentium2': 7, 'Celeron2': 5,
        }

    amd_Column = {
        'EPYC': 0, 'TR': 0, 'R9': 1, 'R7': 2, 'R5': 5, 'R3': 7, 'RE': 7,'Bulldozer': 0, 'APU': 0, 'Phenom': 2, 'Athlon': 4, 'Turion': 6,
        'EPYC2': 0, 'TR2': 0, 'R92': 1, 'R72': 3, 'R52': 4, 'R32': 6, 'RE2': 6,'Bulldozer2': 1, 'APU2': 1, 'Phenom2': 3, 'Athlon2': 5, 'Turion2': 6,
        }
    # 修正分数
    fix_score = {
       'G3220': 230
