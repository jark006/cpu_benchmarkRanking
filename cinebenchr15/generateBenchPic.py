...
if coreType == 'single':
    ...
    intel_dict = {'i3': 4, 'i5': 2, 'i7': 3, 'i9': 4, 'E5': 0, 'Xeon': 1, 'Platinum': 0,
                  'Pentium': 4, 'Core2': 0, 'Core22': 0, 'Celeron': 2, 'Celeron2': 3, }  # 系列太多，为避免堆积，分成两拨

    amd_dict = {'EPYC': 0, 'TR': 0, 'R9': 1, 'R7': 2, 'R5': 3, 'R3': 1, 'RE': 3,
    ...
    percent = [
        ...
        400, 430, 460, 490, 520, 560, 600, 650, 700, 800, 900, 1000,
        1100, 1200, 1400, 1700, 2000, 2500
    ]
    intel_dict2 = {'i3': 0, 'i5': 1, 'i7': 2, 'i9': 2,
                   'Core2': 0, 'Pentium': 0, 'Celeron': 1, 'Celeron2': 1, 'Atom': 2}

    intel_dict = {'i3': 2, 'i5': 0, 'i7': 1, 'i9': 2, 'E5': 4, 'Xeon': 3, 'Platinum': 4,
                  'Core2': 0, 'Core22': 0, 'Pentium': 4, 'Celeron': 0, 'Celeron2': 1, }  # 单系列太多，为避免堆积，分成两拨

    amd_dict = {'EPYC': 0, 'TR': 0, 'R9': 1, 'R7': 2, 'R5': 3, 'R3': 1, 'Bulldozer': 0,
                'APU': 0, 'Phenom': 2, 'Athlon': 3, 'Turion': 3, 'RE': 1}
    # 修正分数
    fix_score = {
       # 'FX-8370': 1300,
       # 'FX-8320': 1090,
